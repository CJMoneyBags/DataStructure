...
def multiples_of(number, length):
    ...
    """
    multiples = [ numbers * number for numbers in range(1, length+1) ] # use List comprehension to multiply the number by the itmes in the range of 
                                                                       # length + 1 (lenght + 1) is to include the last element) 
    return multiples
